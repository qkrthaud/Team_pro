...
<form action="qa_write_save.jsp" method="post">
<h1 style="text-align: center;">질문 작성</h1>
<table class="table" border="1">
	<tr>
		<td class="th-1">이름</td>
		<td class="th-2"><input class="textbox1" type="text" name="name"></td>
	</tr>
	<tr>
		<td class="th-1">제목</td>
	...
	<tr>
		<th colspan="2">
			...
			<input type="button" value="목록으로" onclick="location.href='cafe_Q&A.jsp'">
		</th>
		<td></td>
	</tr>
</table>
